...
public class PersonCheck extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_persono_check);
    ...
    private void initWebView(){
        ...
        webView.loadUrl("file:///android_asset/person_search.html");
    }
