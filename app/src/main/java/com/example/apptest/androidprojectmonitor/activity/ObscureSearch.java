...
public class ObscureSearch extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obscure_search);
    ...
    private void initWebView(){
        ...
        webView.loadUrl("file:///android_asset/obscure_search.html");
    }
